...
static const int _hx_array_data_0363db6a_17[] = {
...
HXLINE( 532)					result->b = ::Array_obj< ::String >::fromData( _hx_array_data_0363db6a_12,1);
            				}
            				else {
...
HXLINE( 546)										result->b = ::Array_obj< ::String >::fromData( _hx_array_data_0363db6a_13,1);
            									}
            									else {
...
HXLINE( 539)									bs_buf->b = ::Array_obj< ::String >::fromData( _hx_array_data_0363db6a_14,1);
            								}
            								else {
...
HXLINE( 562)						result->b = ::Array_obj< ::String >::fromData( _hx_array_data_0363db6a_15,1);
            					}
            					else {
...
HXDLIN( 506)		winMetaCharacters = ::Array_obj< int >::fromData( _hx_array_data_0363db6a_17,15);
            	}
}
